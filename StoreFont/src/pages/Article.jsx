const dummy = [
  {
    id: 1,
    title: "Sample Title",
    title_search: "sampletitle",
    description: "This is a sample description.",
    thumbnail: "sample_thumbnail.jpg",
    content: "<p>This is a sample content.</p>",
    is_active: true,
    is_deleted: false,
    created_at: new Date(2023, 1, 15), // February 15, 2023
    updated_at: new Date(2023, 1, 16), // February 16, 2023
  },
  {
    id: 2,
    title: "Another Example",
    title_search: "anotherexample",
    description: "This is another example description.",
    thumbnail: "another_example_thumbnail.jpg",
    content: "<p>This is another example content.</p>",
    is_active: true,
    is_deleted: false,
    created_at: new Date(2023, 3, 20), // April 20, 2023
    updated_at: new Date(2023, 3, 21), // April 21, 2023
  },
];
